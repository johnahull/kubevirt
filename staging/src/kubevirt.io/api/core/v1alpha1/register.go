...
var (
	ManagedClaimProvisionerGroupVersionKind = schema.GroupVersionKind{
		Group:   core.GroupName,
		Version: SchemeGroupVersion.Version,
		Kind:    ManagedClaimProvisionerKind,
	}
	ManagedClaimProvisionerListGroupVersionKind = schema.GroupVersionKind{
		Group:   core.GroupName,
		Version: SchemeGroupVersion.Version,
		Kind:    ManagedClaimProvisionerListKind,
	}
)
