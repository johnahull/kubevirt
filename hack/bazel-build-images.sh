...
bazel build \
    ...
    //cmd/virt-exportserver:virt-exportserver-image //cmd/synchronization-controller:virt-synchronization-controller-image \
    //cmd/managed-claim-controller:virt-managed-claim-controller-image ${other_images[@]}
